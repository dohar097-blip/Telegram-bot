...
class ClaudeAI:
    ...
    def chat(self, user_id, message, system_prompt=None):
        ...
        if system_prompt is None:
            system_prompt = "আপনি একটি সহায়ক Telegram বট যা বাংলা এবং ইংরেজিতে সাহায্য করে। বন্ধুত্বপূর্ণ এবং পেশাদার থাকুন।"
    ...
    def customer_support(self, user_id, question):
        ...
        গ্রাহকদের সমস্যা সমাধানে সাহায্য করুন, পেশাদার এবং বন্ধুত্বপূর্ণ থাকুন। 
